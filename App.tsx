        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3 pl-6 border-l border-gray-700">
            ...
            <div className="relative group cursor-pointer" onClick={() => setActiveTab('profile')}>
              <img src="https://placehold.co/200" className={`w-10 h-10 rounded-full border-2 transition-colors ${activeTab === 'profile' ? 'border-gold' : 'border-gray-700 group-hover:border-gold'}`} alt="Profile" />
              {activeTab === 'profile' && (
