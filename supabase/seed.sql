...
VALUES
  ('11111111-1111-1111-1111-111111111111', 'Forest Edge Eco-Cabin', 'Transylvania', 'ROU', 4, 120000, 60, 11.5, ARRAY['https://images.unsplash.com/photo-1449156493391-d2cfa28e468b?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=600&auto=format&fit=crop'], ARRAY['Hot Tub', 'Fireplace', 'Smart Home', 'EV Charger']),
  ('22222222-2222-2222-2222-222222222222', 'Lakeside Mirror House', 'Lake Bled', 'SVN', 2, 180000, 25, 9.8, ARRAY['https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1470770903676-69b98201ea1c?q=80&w=600&auto=format&fit=crop'], ARRAY['Private Dock', 'Sauna', 'Panorama Glass', 'Kayak']),
  ('33333333-3333-3333-3333-333333333333', 'River Canyon Lodge', 'Tara Canyon', 'MYS', 6, 145000, 85, 12.2, ARRAY['https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1534447677768-be436bb09401?q=80&w=600&auto=format&fit=crop'], ARRAY['Large Deck', 'BBQ Station', 'River Access', 'Starlink']),
  ('44444444-4444-4444-4444-444444444444', 'Tropical Jungle Dome', 'Ubud', 'MYS', 2, 95000, 40, 13.5, ARRAY['https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1510798831971-661eb04b3739?q=80&w=600&auto=format&fit=crop'], ARRAY['Infinity Pool', 'Jungle View', 'Yoga Deck', 'Scooter Incl.']),
  ('55555555-5555-5555-5555-555555555555', 'Nordic Aurora Glass Igloo', 'Rovaniemi', 'LTU', 2, 165000, 15, 10.2, ARRAY['https://images.unsplash.com/photo-1518182170546-0766ca6fdd69?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?q=80&w=600&auto=format&fit=crop'], ARRAY['Glass Roof', 'Private Sauna', 'Floor Heating', 'Reindeer Safari']),
  ('66666666-6666-6666-6666-666666666666', 'Desert Oasis Tiny Home', 'Joshua Tree', 'USA', 4, 135000, 70, 11.0, ARRAY['https://images.unsplash.com/photo-1516939884455-1445c8652f83?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1505576391880-b3f9d713dc4f?q=80&w=600&auto=format&fit=crop'], ARRAY['Fire Pit', 'Stargazing Deck', 'Outdoor Shower', 'Solar Power']),
  ...
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Ancient Forest Treehouse', 'Bialowieza Forest', 'POL', 2, 110000, 100, 12.8, ARRAY['https://images.unsplash.com/photo-1488413587848-2604974975d0?q=80&w=600&auto=format&fit=crop', 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=600&auto=format&fit=crop'], ARRAY['Treehouse Living', 'Bison Watching', 'Secluded', 'Nature Sounds']);
