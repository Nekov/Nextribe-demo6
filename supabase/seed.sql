...
VALUES
  ...
  ('GRC', 'Greece', 'ambassador', 20, 'Expanding to the stunning landscapes of Greece with rich history and local charm.', 6, 10),
  ('SVN', 'Slovenia', 'ambassador', 20, 'Expanding to the stunning landscapes of Slovenia with rich history and local charm.', 3, 10),
  ('ITA', 'Italy', 'ambassador', 20, 'Expanding to the stunning landscapes of Italy with rich history and local charm.', 7, 10),
  ('MYS', 'Malaysia', 'ambassador', 20, 'Expanding to the stunning landscapes of Malaysia with rich history and local charm.', 5, 10),
  ('CYP', 'Cyprus', 'ambassador', 20, 'Expanding to the stunning landscapes of Cyprus with rich history and local charm.', 4, 10),
  ('FRA', 'France', 'ambassador', 20, 'Expanding to the stunning landscapes of France with rich history and local charm.', 6, 10),
  ('DEU', 'Germany', 'ambassador', 20, 'Expanding to the stunning landscapes of Germany with rich history and local charm.', 5, 10),
  ('GBR', 'United Kingdom', 'ambassador', 20, 'Expanding to the stunning landscapes of United Kingdom with rich history and local charm.', 4, 10),
  ('LTU', 'Lithuania', 'proposed', 15, 'Expanding to the stunning landscapes of Lithuania with rich history and local charm.', 6, 10),
  ('POL', 'Poland', 'proposed', 12, 'Expanding to the stunning landscapes of Poland with rich history and local charm.', 5, 10),
